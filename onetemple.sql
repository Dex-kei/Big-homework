...
CREATE TABLE `friend` (
  `sid` int(11) NOT NULL,
  `f_sid` int(11) NOT NULL DEFAULT 1,
  `name_` varchar(255) NOT NULL,
  `address_` varchar(255) NOT NULL,
  `mobile_` varchar(255) NOT NULL,
...
INSERT INTO `friend` (`sid`, `f_sid`, `name_`, `address_`, `mobile_`, `year`, `month`, `day`) VALUES
(1, 1, '禿禿禿', '基隆市', '0987789789', '1994', '07', '10'),
(2, 9, '拗拗拗', '新北市', '0945654456', '1997', '07', '17'),
(4, 9, '凹你歐', '台南市', '0987963963', '1996', '07', '29'),
(5, 3, '梅梅梅', '新竹市', '0999789789', '1995', '12', '12'),
(6, 9, '台積歌', '新竹縣', '0987789852', '1999', '12', '01'),
(7, 9, '安你你', '屏東市', '0874456654', '1997', '7', '7');
...
INSERT INTO `f_test` (`sid`, `name`, `email`, `mobile`, `address`) VALUES
(1, '安安安', 'deee12@gmail.com', '0987987987', '台北市'),
(6, 'llllllll', 'eadawd@gmail.com', '0987123321', '台東市'),
(9, '你妳你', 'dezaa1215@gamil.com', '0987789987', '台中市');
...
ALTER TABLE `friend`
  ADD PRIMARY KEY (`sid`),
  ADD KEY `testtext_sid` (`f_sid`),
  ADD KEY `testtext_sid_2` (`f_sid`),
  ADD KEY `f_sid` (`f_sid`);
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `f_test`
--
ALTER TABLE `f_test`
